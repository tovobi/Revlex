...
namespace Revlex
{
	public class KeyPress
	{
		...
		public void KeyUp(BlackMagic wowMem)
		{
			Log.Print("Taste!");
			PostMessage((int)wowMem.WindowHandle, WM_KEYUP, (int)Keys.G, 0);
			PostMessage((int)wowMem.WindowHandle, WM_KEYDOWN, (int)Keys.G, 0);
		}
	}
}
