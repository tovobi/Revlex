...
namespace Revlex
{
    ...
    public delegate WowHelpers GetWowObjDataDelegate();
    ...
    public partial class Form1 : Form
    {
        ...
        private RadarOverlay.RadarForm RadarInstance;
		...
		*/
        ...
        public void InitializeAdditionalComponent()
        {
            ...
            // BTN to change parameter for Radar is per default disabled
            btnRadarAccept.Enabled = false;
            ...
            tabControl1.SelectedTab = tabPageRadar;
		...
		*/
        ...
        {
            if (cbxEnableRadar.Checked && RadarThread == null)
            {
                RadarThread = new Thread(StartRadar);
                RadarThread.Start();
                btnRadarAccept.Enabled = true;
                Console.WriteLine("RadarThread.Start()");
            }
            else
            {
                RadarThread.Abort();
                RadarThread = null;
                btnRadarAccept.Enabled = false;
                Console.WriteLine("RadarThread.Abort()");
            }
        }
        ...
        public WowHelpers GetWowObjData()
        {
            return WowHelperObj;
        }
